...
public class ExerciciosController implements Initializable {
    ...
    @FXML
    private Button divisoesTreinoButton; // Novo botão para divisões

    @FXML
    private Button limparSelecaoButton; // Botão para limpar seleções
    ...
    private final Map<String, List<String>> exerciciosSuperior = new LinkedHashMap<String, List<String>>() {{
        put("Peito", Arrays.asList(
                ...
                "Supino com Halteres", "Crucifixo", "Crossover", "Flexão"
        ));
        ...
        put("Triceps", Arrays.asList(
                "Triceps Testa", "Triceps Corda", "Triceps Francês",
